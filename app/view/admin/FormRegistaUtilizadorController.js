    ...
    onClickRegistarUtilizador: function() {
        method:'POST',
            myRequest1 = Ext.Ajax.request({
                ...
                params: { user: Ext.getCmp('username').getValue(), pass: Ext.getCmp('pass').getValue(), id_departamento: Ext.getCmp('id_departamento').getValue(), tipo_funcionario: Ext.getCmp('tipo_funcionario').getValue()}
            });
