    ...
    onClickEditaUtilizador: function() {
        method:'POST',
            myRequest1 = Ext.Ajax.request({
                ...
                params: { usernamefunc: Ext.getCmp('username2').getValue(), pass: Ext.getCmp('password2').getValue(), id_departamento: Ext.getCmp('id_departamento2').getValue(), tipo_funcionario: Ext.getCmp('tipo_funcionario2').getValue()}
            });
