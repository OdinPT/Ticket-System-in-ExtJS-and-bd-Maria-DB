...
$connection = sqlsrv_connect("localhost", "root", "", "emails");
// To protect MySQL injection for Security purpose
$username = stripslashes($username);
$password = stripslashes($password);
$username = sqlsrv_real_escape_string($connection, $username);
$password = sqlsrv_real_escape_string($connection, $password);
// Selecting Database
// SQL query to fetch information of registerd users and finds user match.
$query = sqlsrv_query($connection, "Call Login('$username','$password')");
