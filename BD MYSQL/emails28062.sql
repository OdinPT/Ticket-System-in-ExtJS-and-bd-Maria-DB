...
--
-- Host: 127.0.0.1
-- Generation Time: 28-Jun-2017 às 16:24
...
where IDEstadoEstado=ID_Estado  and IDFuncEstado=id_funcionario and   IdTicketEstado = _id order by idHistoricoEstados desc;
